...
def display_videos(videos, titles, category):
    ...
    print(f"\nTop 10 {category} JRE Clips Videos:\n")
...
def main():
    ...
    """
    print("=== JRE Clips YouTube Top Videos Fetcher ===\n")
    ...
    channel_id = 'UCnxGkOGNMqQEUMvroOWps6Q'  # Channel ID for JRE Clips
    ...
    display_videos(most_recent, titles, category="Most Recent")
    ...
    display_videos(top_viewed, titles, category="Most Viewed")
